...
//
//     cd lessons
//     g++ -std=c++17 ch1_2.cpp -o ch1_2 $(pkg-config --cflags --libs libmongocxx1) && ./ch1_2   # macOS, Homebrew
//     docker compose run --rm cpp lessons/ch1_2.cpp       # то же в контейнере
//
...
int main() {
...

    {
        ...
        std::cout << "Заготовка главы 1.2 подключилась к серверу. Замените проверочные строки примером из главы." << std::endl;
    }
}
