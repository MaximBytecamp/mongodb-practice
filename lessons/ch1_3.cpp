...
//
//     cd lessons
//     g++ -std=c++17 ch1_3.cpp -o ch1_3 $(pkg-config --cflags --libs libmongocxx1) && ./ch1_3   # macOS, Homebrew
//     docker compose run --rm cpp lessons/ch1_3.cpp       # то же в контейнере
//
...
int main() {
...

    {
        ...
        std::cout << "Заготовка главы 1.3 подключилась к серверу. Замените проверочные строки примером из главы." << std::endl;
    }
}
