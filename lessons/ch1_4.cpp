...
//
//     cd lessons
//     g++ -std=c++17 ch1_4.cpp -o ch1_4 $(pkg-config --cflags --libs libmongocxx1) && ./ch1_4   # macOS, Homebrew
//     docker compose run --rm cpp lessons/ch1_4.cpp       # то же в контейнере
//
...
int main() {
...

    {
        ...
        std::cout << "Заготовка главы 1.4 подключилась к серверу. Замените проверочные строки примером из главы." << std::endl;
    }
}
